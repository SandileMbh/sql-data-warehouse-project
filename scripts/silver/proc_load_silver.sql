    ...
    BEGIN TRY
        ...
        *,
        ...
        CASE 
                ...
                WHEN UPPER(TRIM(REPLACE(REPLACE(REPLACE(cntry, CHAR(13), ''), CHAR(10), ''), ' ', ''))) IN ('US', 'USA') THEN 'United States'
                WHEN UPPER(TRIM(REPLACE(REPLACE(REPLACE(cntry, CHAR(13), ''), CHAR(10), ''), ' ', ''))) = '' OR cntry is NULL THEN 'n/a'
        ...
        subcat,
        CASE 
            WHEN (TRIM(REPLACE(REPLACE(REPLACE(maintenance, CHAR(13), ''), CHAR(10), ''), ' ', ''))) IN ('Yes') THEN 'Yes'
            WHEN (TRIM(REPLACE(REPLACE(REPLACE(maintenance, CHAR(13), ''), CHAR(10), ''), ' ', ''))) IN ('No') THEN 'No'
            ELSE 'n/a'
        END AS maintenance
